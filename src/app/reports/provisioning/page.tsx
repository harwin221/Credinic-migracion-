...
export default function ProvisioningReportPage() {
  ...
  const groupedData = reportData.reduce((acc, item) => {
    ...
    if (totals[category as keyof typeof totals]) {
      totals[category as keyof typeof totals].balance += item.remainingBalance;
      totals[category as keyof typeof totals].provision += item.provisionAmount;
      totals[category as keyof typeof totals].count += 1;
    }
                 ...
                 return (
                     <div key={category} className="break-inside-avoid">
                        ...
                        <Table className="report-table-condensed">
                            ...
                            <TableBody>
                                {(credits as ProvisionCredit[]).map(item => (
