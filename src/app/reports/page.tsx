...
import type { UserRole, AppUser as User, Sucursal, Permission } from '@/lib/types';
...
const OFFICE_ROLES: UserRole[] = ['ADMINISTRADOR', 'OPERATIVO', 'FINANZAS', 'GERENTE'];
  ...
  React.useEffect(() => {
    ...
    if (user && !isFieldRole) {
        const fetchData = async () => {
          ...
          setManagers(activeUsers.filter(u => u.role === 'GERENTE'));
