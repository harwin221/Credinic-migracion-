 ...
 * - **GERENTE:** Vista global de reportes y operaciones de su sucursal. Puede gestionar y aprobar todos los créditos de su sucursal sin límite de monto, así como todas las aprobaciones necesarias. No tiene acceso a la configuración del sistema.
