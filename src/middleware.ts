...
export const config = {
  matcher: [
    ...
    // 2. Archivos estáticos de la PWA (manifest, sw.js, workbox, favicon.ico)
    // 3. Archivos estáticos de imágenes (*.png)
    '/((?!api|_next/static|_next/image|favicon.ico|.*\\.png$|manifest.json|manifest.webmanifest|sw.js|workbox-.*\\.js).*)',
  ],
};