...
export interface Client {
    ...
    sucursal: string;
    sucursalName?: string;
    department: string; // Mantener para compatibilidad
    municipality: string; // Mantener para compatibilidad
    departmentId?: string; // Nuevo campo relacional
    municipalityId?: string; // Nuevo campo relacional
    neighborhood: string;
    address: string;
